...
def master_data_file():
    ...
    # return jsonify(master_file)
    # json_file = json.dumps(master_file)

    df = pd.read_json(master_file)

    df.to_json (r'..\Desktop\master_data_file.json')

    # with open('master_data_file.json', 'w') as json_file:
    #     json.dump(master_file, json_file)
